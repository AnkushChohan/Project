...
public partial class BuyParts : System.Web.UI.Page
{
    ...
    protected String ImageFiller1(int i, int count)
    {
        ...
        s1 = "select distinct Pimg,PName,Pprice,Pid from Products";
        //  s0 = "Rs. ";
    ...
    protected String ImageFiller2(int i, int count)
    {
        ...
        s1 = "select distinct Pimg,PName,Pprice,Pid from Products where type='" + ListBox1.SelectedItem + "'";
        //  s0 = "Rs. ";
    ...
    protected void Button4_Click(object sender, EventArgs e)
    {
        ...
        string s1 = ImageFiller2(Convert.ToInt32(Label15.Text) + 0, count + 0);
        ...
        string s2 = ImageFiller2(Convert.ToInt32(Label15.Text) + 1, count + 1);
        ImageButton2.ImageUrl = s2;
        if (s2 == "")
        {
            ImageButton2.Visible = false;
        ...
        string s3 = ImageFiller2(Convert.ToInt32(Label15.Text) + 2, count + 2);
        ImageButton3.ImageUrl = s3;
        if (s3 == "")
        {
            ImageButton3.Visible = false;
        ...
        string s4 = ImageFiller2(Convert.ToInt32(Label15.Text) + 3, count + 3);
        ImageButton4.ImageUrl = s4;
        if (s4 == "")
        {
            ImageButton4.Visible = false;
        ...
        string s5 = ImageFiller2(Convert.ToInt32(Label15.Text) + 4, count + 4);
        ImageButton5.ImageUrl = s5;
        if (s5 == "")
        {
            ImageButton5.Visible = false;
        ...
        string s6 = ImageFiller2(Convert.ToInt32(Label15.Text) + 5, count + 5);
        ImageButton6.ImageUrl = s6;
        ...
        string s7 = ImageFiller2(Convert.ToInt32(Label15.Text) + 6, count + 6);
        ImageButton7.ImageUrl = s7;
        if (s7 == "")
        {
            ImageButton7.Visible = false;
        ...
        string s8 = ImageFiller2(Convert.ToInt32(Label15.Text) + 7, count + 7);
        ImageButton8.ImageUrl = s8;
        if (s8 == "")
        {
            ImageButton8.Visible = false;
        ...
        string s9 = ImageFiller2(Convert.ToInt32(Label15.Text) + 8, count + 8);
        ImageButton9.ImageUrl = s9;
        if (s9 == "")
        {
            ImageButton9.Visible = false;
        ...
        string s10 = ImageFiller2(Convert.ToInt32(Label15.Text) + 9, count + 9);
        ImageButton10.ImageUrl = s10;
        if (s10 == "")
        {
            ImageButton10.Visible = false;
        ...
        string s11 = ImageFiller2(Convert.ToInt32(Label15.Text) + 10, count + 10);
        ImageButton11.ImageUrl = s11;
        if (s11 == "")
        {
            ImageButton11.Visible = false;
        ...
        string s12 = ImageFiller2(Convert.ToInt32(Label15.Text) + 11, count + 11);
        ImageButton12.ImageUrl = s12;
        if (s12 == "")
        {
            ImageButton12.Visible = false;

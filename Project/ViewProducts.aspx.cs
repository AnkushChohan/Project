...
public partial class ViewBuyParts : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!Page.IsPostBack)
        {
            ...
            string s = "select Pid from Products";
    ...
    protected String ImageFiller1(int i, int count)
    {
        ...
        s1 = "select distinct Pimg,Pname,Pprice,Psdesc from Products";
        //  s0 = "Rs. ";
    ...
    protected String ImageFiller2(int i, int count)
    {
        SqlConnection con = new SqlConnection(@"Data Source= DESKTOP-E68R2JU\SQLEXPRESS;Initial Catalog=FakeProduct;Integrated Security=True");
        con.Open();
        string s0 = " ";
        ...
        s1 = "select distinct Pimg,Pname,Pprice,Psdesc from Products where type='" + ListBox1.SelectedItem + "'";
        //  s0 = "Rs. ";
    ...
    protected void ImageButton1_Click(object sender, ImageClickEventArgs e)
    {
        ...
        Session["name"] = LinkButton1.Text;
        Session["price"] = lblp1.Text;
        Session["desc"] = Label4.Text;
    ...
    {
        Session["image"] = ImageButton2.ImageUrl;
        Session["name"] = LinkButton2.Text;
        Session["price"] = lblp2.Text;
        Session["desc"] = Label5.Text;
        Response.Redirect("Comment.aspx");
    }
    ...
    {
        Session["image"] = ImageButton3.ImageUrl;
        Session["name"] = LinkButton3.Text;
        Session["price"] = lblp3.Text;
        Session["desc"] = Label6.Text;
        Response.Redirect("Comment.aspx");
    }
    ...
    {
        Session["image"] = ImageButton4.ImageUrl;
        Session["name"] = LinkButton4.Text;
        Session["price"] = lblp4.Text;
        Session["desc"] = Label7.Text;
        Response.Redirect("Comment.aspx");
    }
    ...
    {
        Session["image"] = ImageButton5.ImageUrl;
        Session["name"] = LinkButton5.Text;
        Session["price"] = lblp5.Text;
        Session["desc"] = Label8.Text;
        Response.Redirect("Comment.aspx");
    }
    ...
    {
        Session["image"] = ImageButton6.ImageUrl;
        Session["name"] = LinkButton6.Text;
        Session["price"] = lblp6.Text;
        Session["desc"] = Label9.Text;
        Response.Redirect("Comment.aspx");
    }
    ...
    {
        Session["image"] = ImageButton7.ImageUrl;
        Session["name"] = LinkButton7.Text;
        Session["price"] = lblp7.Text;
        Session["desc"] = Label10.Text;
        Response.Redirect("Comment.aspx");
    }
    ...
    {
        Session["image"] = ImageButton8.ImageUrl;
        Session["name"] = LinkButton8.Text;
        Session["price"] = lblp8.Text;
        Session["desc"] = Label11.Text;
        Response.Redirect("Comment.aspx");
    }
    ...
    {
        Session["image"] = ImageButton9.ImageUrl;
        Session["name"] = LinkButton9.Text;
        Session["price"] = lblp9.Text;
        Session["desc"] = Label12.Text;
        Response.Redirect("Comment.aspx");
    }
    ...
    {
        Session["image"] = ImageButton10.ImageUrl;
        Session["name"] = LinkButton10.Text;
        Session["price"] = lblp10.Text;
        Session["desc"] = Label13.Text;
        Response.Redirect("Comment.aspx");
    }
    protected void LinkButton10_Click(object sender, EventArgs e)
    {
        ...
        Session["name"] = LinkButton10.Text;
        Session["price"] = lblp10.Text;
        Session["desc"] = Label3.Text;
        Response.Redirect("Comment.aspx");
    }
    protected void ImageButton11_Click(object sender, ImageClickEventArgs e)
    {
        Session["image"] = ImageButton11.ImageUrl;
        Session["name"] = LinkButton11.Text;
        Session["price"] = lblp11.Text;
        Session["desc"] = Label4.Text;
        Response.Redirect("Comment.aspx");
    }
    ...
    {
        Session["image"] = ImageButton12.ImageUrl;
        Session["name"] = LinkButton12.Text;
        Session["price"] = lblp11.Text;
        Session["desc"] = Label15.Text;
        Response.Redirect("Comment.aspx");
    }
    ...
    protected void Button4_Click(object sender, EventArgs e)
    {
        ...
        string s1 = ImageFiller2(Convert.ToInt32(Label2.Text) + 0, count + 0);
        ...
        string s2 = ImageFiller2(Convert.ToInt32(Label2.Text) + 1, count + 1);
        ImageButton2.ImageUrl = s2;
        if (s2 == "")
        {
            ImageButton2.Visible = false;
        ...
        string s3 = ImageFiller2(Convert.ToInt32(Label2.Text) + 2, count + 2);
        ImageButton3.ImageUrl = s3;
        if (s3 == "")
        {
            ImageButton3.Visible = false;
        ...
        string s4 = ImageFiller2(Convert.ToInt32(Label2.Text) + 3, count + 3);
        ImageButton4.ImageUrl = s4;
        if (s4 == "")
        {
            ImageButton4.Visible = false;
        ...
        string s5 = ImageFiller2(Convert.ToInt32(Label2.Text) + 4, count + 4);
        ImageButton5.ImageUrl = s5;
        if (s5 == "")
        {
            ImageButton5.Visible = false;
        ...
        string s6 = ImageFiller2(Convert.ToInt32(Label2.Text) + 5, count + 5);
        ImageButton6.ImageUrl = s6;
        ...
        string s7 = ImageFiller2(Convert.ToInt32(Label2.Text) + 6, count + 6);
        ImageButton7.ImageUrl = s7;
        if (s7 == "")
        {
            ImageButton7.Visible = false;
        ...
        string s8 = ImageFiller2(Convert.ToInt32(Label2.Text) + 7, count + 7);
        ImageButton8.ImageUrl = s8;
        if (s8 == "")
        {
            ImageButton8.Visible = false;
        ...
        string s9 = ImageFiller2(Convert.ToInt32(Label2.Text) + 8, count + 8);
        ImageButton9.ImageUrl = s9;
        if (s9 == "")
        {
            ImageButton9.Visible = false;
        ...
        string s10 = ImageFiller2(Convert.ToInt32(Label2.Text) + 9, count + 9);
        ImageButton10.ImageUrl = s10;
        if (s10 == "")
        {
            ImageButton10.Visible = false;
        ...
        string s11 = ImageFiller2(Convert.ToInt32(Label2.Text) + 10, count + 10);
        ImageButton11.ImageUrl = s11;
        if (s11 == "")
        {
            ImageButton11.Visible = false;
        ...
        string s12 = ImageFiller2(Convert.ToInt32(Label2.Text) + 11, count + 11);
        ImageButton12.ImageUrl = s12;
        if (s12 == "")
        {
            ImageButton12.Visible = false;
    ...
    protected void Button3_Click(object sender, EventArgs e)
    {
        SqlDataAdapter da;
        DataSet ds = new DataSet();
        string s = "select Pid from Products where type='" + ListBox1.SelectedItem + "'";
        da = new SqlDataAdapter(s, con);
        da.Fill(ds);
        Label3.Text = Convert.ToString(ds.Tables[0].Rows.Count);
        ...
        int count = 0;
        string s1 = ImageFiller2(0, count + 0);
        ...
        string s2 = ImageFiller2(1, count + 1);
        ImageButton2.ImageUrl = s2;
        if (s2 == "")
        {
            ImageButton2.Visible = false;
        ...
        string s3 = ImageFiller2(2, count + 2);
        ImageButton3.ImageUrl = s3;
        if (s3 == "")
        {
            ImageButton3.Visible = false;
        ...
        string s4 = ImageFiller2(3, count + 3);
        ImageButton4.ImageUrl = s4;
        if (s4 == "")
        {
            ImageButton4.Visible = false;
        ...
        string s5 = ImageFiller2(4, count + 4);
        ImageButton5.ImageUrl = s5;
        if (s5 == "")
        {
            ImageButton5.Visible = false;
        ...
        string s6 = ImageFiller2(5, count + 5);
        ImageButton6.ImageUrl = s6;
        ...
        string s7 = ImageFiller2(6, count + 6);
        ImageButton7.ImageUrl = s7;
        if (s7 == "")
        {
            ImageButton7.Visible = false;
        ...
        string s8 = ImageFiller2(7, count + 7);
        ImageButton8.ImageUrl = s8;
        if (s8 == "")
        {
            ImageButton8.Visible = false;
        ...
        string s9 = ImageFiller2(8, count + 8);
        ImageButton9.ImageUrl = s9;
        if (s9 == "")
        {
            ImageButton9.Visible = false;
        ...
        string s10 = ImageFiller2(9, count + 9);
        ImageButton10.ImageUrl = s10;
        if (s10 == "")
        {
            ImageButton10.Visible = false;
        ...
        string s11 = ImageFiller2(10, count + 10);
        ImageButton11.ImageUrl = s11;
        if (s11 == "")
        {
            ImageButton11.Visible = false;
        ...
        string s12 = ImageFiller2(11, count + 11);
        ImageButton12.ImageUrl = s12;
        if (s12 == "")
        {
            ImageButton12.Visible = false;
